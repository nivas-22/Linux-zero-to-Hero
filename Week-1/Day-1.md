...
3. ls - list of files
4. unmae - System information
5. hostname – Show/Set System Hostname



-----------------------------------------------------------------------------

# DATE - Flag/Format Description
...
-m Print machine hardware name (x86 64)
-p Print processor type
-o Print operating system

Host Name - Flag Description
